...
int main(int argc, char** argv) {
    ...
    ros::Subscriber sub2 = n.subscribe("goal", 10, goal_callback);   //ececute this
    ros::Subscriber sub3 = n.subscribe("traj_start_trigger", 10, traj_start_trigger_callback);  //do not execute
